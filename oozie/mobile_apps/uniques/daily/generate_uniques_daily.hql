...
-- Hard-limiting number of reducer to force a single file in the target directory.
...
(
    ...
    WHERE user_agent LIKE('WikipediaApp%')
        ...
        AND parse_url(concat('http://bla.org/woo/', uri_query), 'QUERY', 'appInstallID') IS NOT NULL
