...
CREATE EXTERNAL TABLE IF NOT EXISTS `tmp_druid_mediawiki_history` (
  ...
  `page_namespace_is_content_historical`          int           COMMENT 'In revision/page events: historical namespace of the page is categorized as content',
  `page_namespace`                                int           COMMENT 'In revision/page events: current namespace of the page',
  `page_namespace_is_content`                     int           COMMENT 'In revision/page events: current namespace of the page is categorized as content',
  `page_is_redirect`                              int           COMMENT 'In revision/page events: whether the page is currently a redirect',
...
SELECT
    ...
    CASE WHEN page_namespace_is_content_historical THEN 1 ELSE 0 END AS page_namespace_is_content_historical,
    page_namespace,
    CASE WHEN page_namespace_is_content THEN 1 ELSE 0 END AS page_namespace_is_content,
    CASE WHEN page_is_redirect THEN 1 ELSE 0 END AS page_is_redirect,
