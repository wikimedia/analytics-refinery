...
CREATE EXTERNAL TABLE `mediawiki_revision` (
  ...
  `rev_sha1`            string      COMMENT 'This field is used to add the SHA-1 text content hash in base-36 (generated by wfBaseConvert().)',
