...
CREATE EXTERNAL TABLE `mediawiki_page_history`(
    ...
    page_ﬁrst_edit_timestamp              string              COMMENT 'Timestamp of the page\'s first revision.',
    --page_ﬁrst_edit_timestamp              timestamp           COMMENT 'Timestamp of the page\'s first revision.',
