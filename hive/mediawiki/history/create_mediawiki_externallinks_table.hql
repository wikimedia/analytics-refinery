...
--
-- Usage
--     hive -f create_mediawiki_externallinks_table.hql \
--         --database wmf_raw
--
...
COMMENT
  'See most up to date documentation at https://www.mediawiki.org/wiki/Manual:Externallinks_table'
PARTITIONED BY (
...
LOCATION
  'hdfs://analytics-hadoop/wmf/data/raw/mediawiki/tables/externallinks'
;
