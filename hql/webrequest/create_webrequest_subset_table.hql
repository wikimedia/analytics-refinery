-- Creates table statement for refined webrequest_subset table.
--
...
--
-- Usage
--     hive -f create_webrequest_subset_table.hql --database wmf
--

CREATE EXTERNAL TABLE IF NOT EXISTS `webrequest_subset`(
...
PARTITIONED BY (
    ...
    `subset`            String  COMMENT 'The subset to query - WARNING - You should always only pick a SINGLE SUBSET to prevent overcounting'
)
STORED AS PARQUET
LOCATION '/wmf/data/wmf/webrequest_subset'
;
