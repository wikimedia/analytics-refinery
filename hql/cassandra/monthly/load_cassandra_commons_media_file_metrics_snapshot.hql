-- Load commons.media_file_metrics_snapshot monthly dataset to cassandra.
--
-- Parameters:
...
--     -f load_cassandra_commons_media_file_metrics_snapshot.hql \
--     -d destination_table=aqs.commons.media_file_metrics_snapshot \
