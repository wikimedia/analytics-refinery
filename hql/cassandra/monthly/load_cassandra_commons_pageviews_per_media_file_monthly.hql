-- Load commons.pageviews_per_media_file_monthly dataset to cassandra.
--
-- Parameters:
...
/*+ COALESCE(${coalesce_partitions}) */
    ...
    pageview_count,
    dt
FROM prepared_pageviews_by_media_file
WHERE media_file IS NOT NULL -- remove 'all-media-files' nulls generated by GROUP BY CUBE, as they are not aggregatable
ORDER BY
    media_file,
    wiki,
    dt
