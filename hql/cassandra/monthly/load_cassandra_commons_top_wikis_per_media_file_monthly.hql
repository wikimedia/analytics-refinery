-- Load commons.top_wikis_per_media_file_monthly dataset to cassandra.
--
-- Parameters:
...
--     -d destination_table=aqs.commons.top_wikis_per_media_file_monthly \
...
top_ranked_pageviews_per_media_file AS (
    SELECT *
    FROM (
        SELECT
            media_file,
...
top_ranked AS (
    ...
    FROM top_ranked_pageviews_per_media_file
)
