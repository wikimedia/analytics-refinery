-- Create table statement for the commons_pageviews_by_category table.
--
-- Parameters:
--     <none>
--
-- Usage
--     spark3-sql -f create_commons_pageviews_by_category.hql \
--                --database wmf_contributors
--                -d location=/wmf/data/wmf_contributors/commons/pageviews_by_category
--
CREATE EXTERNAL TABLE IF NOT EXISTS `commons_pageviews_by_category`
(
