...
--                -d location=hdfs://analytics-hadoop/wmf/data/wmf_contributors/commons/media_file_metrics_snapshot
--
...
(
    ...
    `leveraging_wiki_count` INT             COMMENT 'The number of wikis featuring this media file at least in one (namespace=0) page.',
    `leveraging_page_count` INT             COMMENT 'The number of (namespace=0) pages featuring this media file across all wikis.',
