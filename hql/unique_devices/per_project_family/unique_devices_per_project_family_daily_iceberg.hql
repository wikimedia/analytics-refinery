-- Insert into Iceberg unique devices per-project-family daily from Hive table
--
-- Parameters:
...
--         -f unique_devices_per_project_family_daily_iceberg.hql \
--         -d unique_devices_source_table=wmf.unique_devices_per_project_family_daily \
--         -d unique_devices_destination_table=wmf_readership.unique_devices_per_project_family_daily \
--         -d year=2022 \
--         -d month=8 \
--         -d day=14 \
