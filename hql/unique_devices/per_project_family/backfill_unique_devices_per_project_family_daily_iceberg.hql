-- Backfills the daily per-project-family unique devices from the original hive table
--
...
--         -f backfill_unique_devices_per_project_family_daily_iceberg.hql \
--         -d unique_devices_hive_table=wmf.unique_devices_per_project_family_daily \
--         -d unique_devices_iceberg_table=wmf_readership.unique_devices_per_project_family_daily
...
SORT BY day, project_family, country_code
;
