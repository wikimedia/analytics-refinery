-- Extracts one hour of formatted hourly pageviews to be loaded in Druid
--
-- Usage:
--     spark3-sql --master yarn -f generate_hourly_druid_pageviews_hourly.hql \
...
--         -d destination_table=tmp_hourly_druid_pageviews_2020_03_10_10 \
