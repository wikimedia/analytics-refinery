-- Extracts one month of formatted minutely banner activity to be loaded in Druid
--
-- Usage:
--     spark-sql -f generate_daily_druid_banner_activity.hql \
--         -d source_table=wmf.webrequest \
--         -d destination_table=tmp_banner_activity_2023_01 \
--         -d destination_directory=/wmf/tmp/druid/monthly_banner_activity \
