...
--
-- Usage:
-- spark3-sql -f php.hql                                           \
--            -d source_table=event_sanitized.mediawikipingback    \
--            -d destination_dir=/wmf/tmp/analytics/reports/pingback/php
--            -d agg_results_path=/wmf/data/published/datasets/periodic/reports/pingback/php.tsv    \
