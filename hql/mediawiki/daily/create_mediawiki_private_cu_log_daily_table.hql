-- Creates table statement for raw mediawiki_private_cu_log_daily table.
--
-- Parameters:
--     <none>
--
-- Usage
--     spark3-sql -f create_mediawiki_private_cu_log_daily_table.hql  \
--          --database wmf_raw
--


CREATE EXTERNAL TABLE `mediawiki_private_cu_log_daily` (
...
PARTITIONED BY (
  `day` string COMMENT 'The day in YYYY-MM-DD format, all cu_log events from that day are imported',
...
LOCATION
  'hdfs://analytics-hadoop/wmf/data/raw/mediawiki_private/tables/daily/cu_log'
;
