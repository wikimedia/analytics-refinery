...
CREATE EXTERNAL TABLE `geoeditors_monthly` (
  ...
  `users_are_temporary`             boolean     COMMENT 'Whether or not this group of editors edited as temporary user',
  `users_are_permanent`             boolean     COMMENT 'Whether or not this group of editors edited as permanent users',
