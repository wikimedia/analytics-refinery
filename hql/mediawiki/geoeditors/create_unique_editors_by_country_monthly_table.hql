...
CREATE EXTERNAL TABLE `unique_editors_by_country_monthly` (
  ...
  `users_are_permanent`             boolean     COMMENT 'Whether or not this group of editors are permanent users',
  `users_are_temporary`             boolean     COMMENT 'Whether or not this group of editors are temporary users',
