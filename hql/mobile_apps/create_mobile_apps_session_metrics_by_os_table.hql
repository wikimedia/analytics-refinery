-- Creates table statement for mobile apps session metrics by os family daily table.
...
--
-- Usage
--     hive -f create_mobile_apps_session_metrics_by_os_table.hql --database wmf
--

CREATE EXTERNAL TABLE IF NOT EXISTS `mobile_apps_session_metrics_by_os`(
    ...
    `os_family`            string  COMMENT 'OS family breakdown',
...
LINES TERMINATED BY '\n'
LOCATION '/wmf/data/wmf/mobile_apps/session_metrics_by_os'
;